    ...
    <div class="modal" id="editModal" tabindex="-1" style="display: block;">
                                                ...
                                                echo "<tr>";
                                                    ...
                                                    if ($eachChiTiet['anhs_sanpham'] != null) {
                                                        echo "<td style='width: 5%; text-align: -webkit-center;'>
                                                                <img src='". $eachChiTiet['anhs_sanpham'] . "' class='img-thumbnail' alt='...'>
                                                            </td>";
                                                    } else {
                                                        echo "<td style='width: 5%; text-align: -webkit-center;'>
                                                        ...
                                                        echo "<td class='text-center'>
                                                                <div class='dropdown'>
                                                                    ...
                                                                    <ul class='dropdown-menu'>
                                                                        ...
                                                                        <li class='d-flex align-items-center'>
                                                                            <a style='cursor: pointer;' class='dropdown-item d-flex align-items-center fs-5' href='DeleteDetailProduct.php?id=" . $eachChiTiet['id'] . "'>
        ...
        <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true" style="background: rgb(0,0,0,0.5);">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <form action="process_insert_product_detail.php" method="post" class="form-add" style="height: 100%; width: 100%;">
                    <div class="modal-content">
                        <div class="modal-header">
