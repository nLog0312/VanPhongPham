        ...
        foreach ($result as $index => $each) {
            ...
            echo "<tr>";
                ...
                echo "<td class='text-center' style='width: 10%'>";
                    echo "
                        <object style='max-width: 5rem; text-align: -webkit-center;' data='" . $each['anh_sanpham'] . "' type='image/png'>
                        ...
                        <div class='dropdown'>
                            ...
                            <ul class='dropdown-menu'>
                                <li class='d-flex align-items-center'>
                                    <a href='view_detail_product.php?id=" . $each['ma_sanpham'] . "' class='dropdown-item d-flex align-items-center fs-5'>
